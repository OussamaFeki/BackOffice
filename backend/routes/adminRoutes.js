...
router.get('/admin/stadeOwners/numberofowner',adminController.givelength)
...
//Get All Players
router.get('/admin/players',adminController.viewallPlayer);
//create Player
router.post('/admin/addplayer',adminController.createPlayer);
